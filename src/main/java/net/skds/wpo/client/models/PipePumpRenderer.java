...
public class PipePumpRenderer extends TileEntityRenderer<PipePumpTileEntity> {
	...
	public PipePumpRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		...
		zasos.setTextureOffset(0, 0).addBox(-13.0F, -13.0F, 0.0F, 10.0F, 10.0F, 16.0F, 0.0F, false);
		...
		zasos.setTextureOffset(26, 47).addBox(-11.0F, -16.0F, 14.0F, 6.0F, 16.0F, 1.0F, 0.0F, false);

		cube_r2 = new ModelRenderer(64, 64, 0, 0);
		cube_r2.setRotationPoint(-8.0F, -8.0F, 1.5F);
		zasos.addChild(cube_r2);
		setRotationAngle(cube_r2, 3.1416F, 0.0F, -1.5708F);
		cube_r2.setTextureOffset(26, 47).addBox(-3.0F, -8.0F, -0.5F, 6.0F, 16.0F, 1.0F, 0.0F, false);

		cube_r3 = new ModelRenderer(64, 64, 0, 0);
		cube_r3.setRotationPoint(-8.0F, -8.0F, 14.5F);
		zasos.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.0F, 0.0F, -1.5708F);
		cube_r3.setTextureOffset(26, 47).addBox(-3.0F, -8.0F, -0.5F, 6.0F, 16.0F, 1.0F, 0.0F, false);

		cube_r4 = new ModelRenderer(64, 64, 0, 0);
		cube_r4.setRotationPoint(-8.0F, -8.0F, 1.5F);
		zasos.addChild(cube_r4);
		setRotationAngle(cube_r4, 3.1416F, 0.0F, 0.0F);
		cube_r4.setTextureOffset(26, 47).addBox(-3.0F, -8.0F, -0.5F, 6.0F, 16.0F, 1.0F, 0.0F, false);
