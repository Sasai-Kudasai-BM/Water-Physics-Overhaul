...
@OnlyIn(Dist.CLIENT)
public class PipePumpRenderer implements BlockEntityRenderer<PipePumpBlockEntity> {
    ...
    public PipePumpRenderer(BlockEntityRendererProvider.Context context) {
        // rendererDispatcherIn.textureManager.bindTexture(TEXTURE);

        ModelPart modelpart = context.bakeLayer(WPOModelLayers.PIPE_PUMP);
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition zasosPart = root.addOrReplaceChild("zasos", CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-13.0F, -13.0F, 0.0F, 10.0F, 10.0F, 16.0F)
                        .texOffs(0, 46).addBox(-1.0F, -11.0F, 2.0F, 1.0F, 6.0F, 12.0F)
                        .texOffs(0, 46).addBox(-16.0F, -11.0F, 2.0F, 1.0F, 6.0F, 12.0F)
                        .texOffs(26, 47).addBox(-11.0F, -16.0F, 14.0F, 6.0F, 16.0F, 1.0F)
        ...
        zasosPart.addOrReplaceChild("cube_r2", CubeListBuilder.create()
                        .texOffs(26, 47).addBox(-3.0F, -8.0F, -0.5F, 6.0F, 16.0F, 1.0F)
                , PartPose.offsetAndRotation(-8.0F, -8.0F, 1.5F, 3.1416F, 0.0F, -1.5708F));
        zasosPart.addOrReplaceChild("cube_r3", CubeListBuilder.create()
                        .texOffs(26, 47).addBox(-3.0F, -8.0F, -0.5F, 6.0F, 16.0F, 1.0F)
                , PartPose.offsetAndRotation(-8.0F, -8.0F, 14.5F, 0.0F, 0.0F, -1.5708F));
        zasosPart.addOrReplaceChild("cube_r4", CubeListBuilder.create()
                        .texOffs(26, 47).addBox(-8.0F, -3.0F, -6.0F, 1.0F, 6.0F, 12.0F)
                , PartPose.offsetAndRotation(-8.0F, -8.0F, 1.5F, 3.1416F, 0.0F, 0.0F));
    ...
    @Override
    public void render(PipePumpBlockEntity tileEntityIn, float partialTicks, PoseStack matrixStackIn,
